...
| `failed` | Consegna email non riuscita (dominio non valido, mailbox piena, un template non pubblicato, ecc.). Il motivo viene registrato sull'email e mostrato in dashboard; l'API restituisce lo status, non il motivo |
