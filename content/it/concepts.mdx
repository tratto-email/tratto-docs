...
Un template nasce come `draft` e deve essere `published` prima di poter essere usato per inviare. Vedi [Template](/it/docs/templates#pubblica-prima-di-inviare).
