...
Vedi [Autenticazione](/docs/it/authentication) per gestire le chiavi.
...
Vedi [Domini](/docs/it/domains) per la configurazione passo dopo passo.
...
Vedi [Stato e Ciclo di Vita dell'Email](/docs/it/email-status) per ulteriori informazioni.
...
Vedi [Webhook](/docs/it/webhooks) per il codice di verifica della firma.
...
Vedi [Template](/docs/it/templates) per la documentazione completa.
...
Vedi [Flussi](/docs/it/flows) per la configurazione dettagliata.
...
Vedi [Campagne](/docs/it/campaigns) per i dettagli.
...
Vedi [Audience](/docs/it/audiences) per la configurazione.

---

## Prossimi Passi

- **Autenticazione?** Inizia con [API Key e Auth](/docs/it/authentication)
- **Pronto a inviare?** Vai a [Quickstart](/docs/it/quickstart)
- **Approfondisci?** Esplora i singoli concetti:
  - [Domini](/docs/it/domains)
  - [Template](/docs/it/templates)
  - [Contatti](/docs/it/contacts)
  - [Campagne](/docs/it/campaigns)
  - [Webhook](/docs/it/webhooks)
  - [Flussi](/docs/it/flows)
