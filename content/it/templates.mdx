...
|---|---|
| `POST /v1/campaigns` con `templateId` | **422** `VALIDATION_ERROR` |
| `PATCH /v1/campaigns/:id` che sostituisce `templateId` | **422** `VALIDATION_ERROR` |
| `POST /v1/flows/:id/activate` con uno step `send_email` che lo usa | **422** `VALIDATION_ERROR` (**404** se il template non esiste) |
