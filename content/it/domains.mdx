...
| SPF | TXT | `hello.tuodominio.it` | `v=spf1 include:amazonses.com ~all` | Consigliato |
...
Questo autorizza Amazon SES a inviare per l'hostname. Un hostname può avere un solo record SPF: se ne ha già uno, aggiungi `include:amazonses.com` a quello invece di crearne un secondo.
