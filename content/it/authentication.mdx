...
Vedi [Idempotenza](/docs/it/idempotency) per ulteriori dettagli.

---

## Prossimi Passi

- **Pronto a inviare?** Vai a [Invia Email](/docs/it/send-email)
- **Devi verificare i domini?** Vedi [Domini](/docs/it/domains)
- **Comprendi tutti i codici di errore?** Controlla [Codici di Errore](/docs/it/error-codes)
