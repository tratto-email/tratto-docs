...
| `QUOTA_EXCEEDED` | 429 | Raggiunto un limite del piano: quota mensile di email, numero di domini, o tetto giornaliero del test mode | Passa a un piano superiore o attendi il reset |
...
- **`QUOTA_EXCEEDED`**: hai raggiunto un limite del piano, come il monte email
  mensile. Riprovare non serve finché il limite non si resetta o il piano non
  viene aggiornato.
